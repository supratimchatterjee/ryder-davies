	...
	<div class="off-canvas position-left mobile-ofc" id="offCanvas" data-off-canvas>
			...
			<div class="top-header-bar primary-block">
				...
				?>
					...
					<img src="<?php echo get_template_directory_uri(); ?>/img/icon-fb.png"> <span><?php echo $fb_label;  ?></span>
					</a><?php endif; ?>
				...
				<?php endif; ?>
					<?php if($registration):?>
					<a href="<?php echo $registration; ?>"><img class="new" src="<?php echo get_template_directory_uri(); ?>/img/pencil.png"> <span>REGISTRATION</span></a>
					<?php endif;?> 
				...
				<div class="row">
					<div class="medium-6 columns socail"> 
						...
						?>
							...
							<?php if(!empty($fb_link)):?><a href="<?php echo $fb_link; ?>"><?php endif; ?>
